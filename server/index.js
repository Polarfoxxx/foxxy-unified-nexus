...
app.use(cors({
    origin: 'https://zesty-cuchufli-29025b.netlify.app', // Your frontend URL
    credentials: true
}));
app.use(cookieParser());

// Middleware for setting CORS headers manually
...
app.use('/logOut', post_LogOut); // Logout POST method
